...
# TODO
# - azure pipelines
#   - publish 11.x.x versions to int.nuget + update changelog
...
function UpdateChangelog($version) {
    ...
    WriteSectionFooter "Changelog has changed." $true
...
try {
    ...
    # TODO temp
    $newVersions = $newVersions | Where-Object { $_.StartsWith("11.") };
